...
minetest.register_node("loria:chromium_fluoride_volutes", {
    ...
    tiles = map(function(postfix)
                ...
                { "loria_volutes_top.png",
                  "loria_volutes_bottom.png",
                  "loria_volutes.png",
                  "loria_volutes.png",
                  "loria_volutes.png",
                  "loria_volutes.png" }),
...
minetest.register_node("loria:blowed_out_glow_stick", {
    ...
    drawtype = "torchlike",
    tiles = {
        "loria_blowed_out_glow_stick_on_floor.png",
...
minetest.register_node("loria:glow_stick", {
    ...
    drawtype = "torchlike",
    tiles = { "loria_glow_stick_on_floor.png", "loria_glow_stick_on_ceiling.png", "loria_glow_stick.png" },
...
minetest.register_node("loria:lead_box", {
    ...
    tiles = {
        "loria_lead_box_top.png", "loria_lead_box_bottom.png",
...
minetest.register_node("loria:silicon_box", {
    ...
    tiles = {
        "loria_silicon_box_top.png", "loria_silicon_box_bottom.png",
